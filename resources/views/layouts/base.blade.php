                            ...
                            <ul>
                                <li class="menu-item">
                                    <a title="Hotline: (+123) 456 789" href="#">
                                        <span class="icon label-before fa fa-mobile">
                                        </span>
                                        Hotline: (+123) 456 789
                                    </a>
                                </li>
                            ...
                            <ul>
                                ...
                                @if (Route::has('login'))
                                    @auth
                                        @if (Auth::user()->u_type === 'ADM')
                                            <li class="menu-item menu-item-has-children parent">
                                                ...
                                                <ul class="submenu curency">
                                                    ...
                                                    <li class="menu-item">
                                                        <a title="Products" href="">All Products</a>
                                                    </li>
                                                    <li class="meπwebnu-item">
                                                        <a title="Manage Home Slider" href="">Manage Home Slider</a>
                                                    </li>
                                                    <li class="menu-item">
                                        ...
                                        @endif
                                    @else
                                        <li class="menu-item"><a title="Register or Login" href="{{ route('login') }}">
                                                Login
                                            </a>
                                        </li>
                                        <li class="menu-item">
